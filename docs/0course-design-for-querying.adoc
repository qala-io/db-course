...
** This is called a linear-complexity algorithm and is denoted $\theta(n)$. It means that the algorithm scales
...
* Search Trees are fast to search through and to update: both are $\theta(log n)$
