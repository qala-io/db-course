...
* SQL basics: at least `select`, `join`, `group by`, `order by`
...
* Searching in sorted arrays is much faster: `..., -3, 0, 5, 12, 24, 100, 101, ...`
* But updates in the beginning or in the middle are slow
* Search Trees are fast to search through and to update
